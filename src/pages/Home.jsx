    ...
    <>
      <section ref={heroRef} className="">
        <div className="block--container">
          <div className="flex px-5 py-10 my-10 mx-auto space-y-0 ">
            {/* Left Content */}
            ...
            {/* Right - Spline */}
            <div className="relative flex-1 w-full sm:mt-4 sm:mb-4 sm:ml-2 xs:hidden md:block">
              <div className="spline absolute top-[8%] right-[-3%] sm:flex-row sm:relative">
