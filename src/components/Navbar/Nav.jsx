...
{/*  */}
        ...
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="md:flex md:items-center md:gap-12">
              ...
              {/* <button
                onClick={() => setIsMenuOpen(!isMenuOpen)}
                className="block md:hidden rounded-lg bg-white/30 p-2 text-purple-900 transition hover:bg-white/50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="size-5"
      ...
      {/* <header
        ...
        className={`fixed w-full border-b bg-amber-50 border-gray-200  transition-transform duration-300 ${
          showNavbar ? "translate-y-0" : "-translate-y-full"
        }`}
      >
        
            
        <div className="mx-auto max-w-screen-xl px-4 xm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex-1 md:flex md:items-center md:gap-12">
              <Link to={"/"} className="block text-teal-600 dark:text-teal-300" href="#">
                <span className="sr-only">Home</span>
                <svg
                  className="h-8"
                  viewBox="0 0 28 24"
            ...
            <div className="md:flex md:items-center md:gap-12">
              <nav aria-label="Global" className=" md:block">
                <ul className="flex items-center gap-6 text-xm">
                  <li>
                    <Link
                      className=" transition hover:/75 text-black"
                      href="#"
                    >
                      About
                    </Link>
              ...
              <div className="relative hidden md:block">
                ...
                <div
                  className="absolute end-0 z-10 mt-0.5 w-56 rounded-md border border-gray-100 bg-white shadow-lg dark:border-gray-800 "
                  role="menu"
                >
                  <div className="p-2">
                    <Link
                      href="#"
                      className="block rounded-lg px-4 py-2 text-xm  hover:bg-gray-50 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-gray-300"
                      role="menuitem"
                    >
                      My profile
                    </Link>
                    ...
                    <form method="POST" action="#">
                      <button
                        type="submit"
                        className="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-xm text-red-700 hover:bg-red-50 dark:text-red-500 dark:hover:bg-red-600/10"
                        role="menuitem"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="block md:hidden">
                  <button className="rounded-xm bg-gray-100 p-2 text-gray-600 transition hover:text-gray-600/75 dark:bg-gray-800 text-black">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="size-5"
                      fill="none"
