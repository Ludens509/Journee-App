    ...
    <>
      ...
      >
        <div className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-evenly md:justify-between px-6">
            {/* Logo Section */}
            <div className="flex-1 md:flex md:items-center md:gap-12">
              ...
              >
                ...
                <img src={LogoDesign} alt="Journee Logo" className=" w-14 inline-block mr-2 rounded-full" />
                {/* <svg
